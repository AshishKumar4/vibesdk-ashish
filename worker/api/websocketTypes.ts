...
type StateMessage<T extends BaseProjectState> = {
	type: 'cf_agent_state';
	state: T;
};

type AgentConnectedMessage<T extends BaseProjectState> = {
...
export type WebSocketMessage =
	| StateMessage<BaseProjectState>
	| AgentConnectedMessage<BaseProjectState>

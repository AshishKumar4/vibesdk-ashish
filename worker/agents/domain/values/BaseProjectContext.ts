...
import { FileTreeNode } from '../../../services/sandbox/sandboxTypes';

/**
 * BaseProjectContext - Universal context for all project types∂
 */
export abstract class BaseProjectContext {
    constructor(
